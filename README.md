...
GHOST Security Console is a Python-based defensive security assessment toolkit designed for authorized security testing, learning, and system/network auditing.

«🛡️ Use this tool only on systems, networks, and websites that you own or have explicit permission to assess.»
